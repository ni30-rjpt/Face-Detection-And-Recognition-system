...
class Login_GUI:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Dell\OneDrive\Desktop\Face_Rec\college_images\hackers2.jpg")
        ...
        if self.txt_email.get() == ""or self.txt_pass_.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", user="root", password="2002", database="face_recognizer")
                cur = conn.cursor()
                cur.execute("select * from register where email=%s and pass=%s",(
                    self.txt_email.get(), 
                    self.txt_pass_.get()
                ))
                row = cur.fetchone()
...
class Register_GUI:
    def __init__(self, root):
        ...
        # --------Left Image --------------------
        self.bg1 = ImageTk.PhotoImage(file=r"C:\Users\Dell\OneDrive\Desktop\Face_Rec\college_images\facialrecognition (1).png")
        ...
        img = Image.open(r"C:\Users\Dell\OneDrive\Desktop\Face_Rec\college_images\register-now-button1.jpg")
...
class Attendence_System:
    def __init__(self, root):
        ...
        # Title 1------->
        title_lbl = Label(BG_img, text="FACE DETECTION AND RECOGNISATION SYSTEM", font=(
            "times new roman", 30, "bold"), bg="black", fg="white")
        title_lbl.place(x=0,y=-2,width=1530,height=55)

        # Title 2------->
        title_lbl = Label(BG_img, text="CSE DEPARTMENT OF BBSBEC", font=(
            "times new roman", 25, "bold"), bg="pink", fg="blue")
        ...
        b1_1 = Button(BG_img, text="Employee Details",command=self.student_details, cursor="hand2", font=(
