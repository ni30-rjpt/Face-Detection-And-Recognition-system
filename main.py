...
class Attendence_System:
    def __init__(self, root):
        ...
        lbl.place(x=0,y=0,width=300,height=50)
        time()
        ...
        b1 = Button(BG_img,cursor="hand2", command=self.help_data, image=self.photoimg8)
        ...
        b1 = Button(BG_img,cursor="hand2", command=self.developer_data, image=self.photoimg10)
